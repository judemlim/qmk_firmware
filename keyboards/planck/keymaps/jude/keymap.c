...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    KC_RIGHT_ALT, KC_LCTL, KC_LALT, KC_LGUI,  KC_SPC,  ALT_T(KC_ENT),  LT(_LOWER, KC_BSPC),  LT(_RAISE, KC_TAB),   CTL_T(KC_LEFT), KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, RALT(KC_A), RALT(KC_O), RALT(KC_E), RALT(KC_U), RALT(KC_I), _______, KC_EQL,    KC_LPRN, KC_RPRN, KC_BSLS, KC_ENT,
...
[_EXT] = LAYOUT_planck_grid(
    ...
    KC_GRV, KC_1,  G(KC_X),  G(KC_C),  G(KC_V),  G(KC_B),  KC_6,  KC_7,  KC_8,  KC_9,  KC_0,  KC_F12,
    _______, _______,   C(KC_X),   C(KC_C),   C(KC_V),  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
